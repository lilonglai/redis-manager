...
public interface INodeInfoDao {
    ...
    @Insert("<script>" +
            ...
            "#{nodeInfo.usedCpuSys}, #{nodeInfo.cpuSys}, #{nodeInfo.usedCpuUser}, #{nodeInfo.cpuUser}, #{nodeInfo.keys}, #{nodeInfo.expires}, current_timestamp)" +
            "</foreach>" +
            "</script>")
    ...
    @Select("CREATE TABLE node_info_${clusterId} ( " +
            "info_id integer NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 100, INCREMENT BY 1), " +
            "node varchar(50) NOT NULL, " +
            "role varchar(50) NOT NULL, " +
            "time_type integer NOT NULL, " +
            "last_time smallint NOT NULL, " +
            "response_time integer NOT NULL, " +
            "connected_clients bigint NOT NULL, " +
            "client_longest_output_list bigint NOT NULL, " +
            "client_biggest_input_buf bigint NOT NULL, " +
            ...
            "used_memory_dataset_perc decimal(6, 2) NOT NULL, " +
            "mem_fragmentation_ratio decimal(6, 2) NOT NULL, " +
            "total_connections_received bigint NOT NULL, " +
            "connections_received bigint NOT NULL, " +
            ...
            "net_input_bytes bigint NOT NULL, " +
            "total_net_output_bytes bigint NOT NULL, " +
            "net_output_bytes bigint NOT NULL, " +
            "sync_full integer NOT NULL, " +
            "sync_partial_ok integer NOT NULL, " +
            "sync_partial_err integer NOT NULL, " +
            "keyspace_misses bigint NOT NULL, " +
            "keyspace_hits bigint NOT NULL, " +
            "keyspace_hits_ratio decimal(6, 2) NOT NULL, " +
            "used_cpu_sys decimal(20, 2) NOT NULL, " +
            "cpu_sys decimal(20, 2) NOT NULL, " +
            "used_cpu_user decimal(20, 2) NOT NULL, " +
            "cpu_user decimal(20, 2) NOT NULL, " +
